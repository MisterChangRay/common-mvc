...
<body marginheight="0"><h1>common-core</h1>
<p>基于maven的spring4.3+mybatis3.4+swagger2.6的后台整合，用于快速构建中小型API、RESTful API项目，该项目简单、快速，使我们摆脱那些重复劳动，专注于业务代码的编写。
...
<ul>
    ...
    <li>访问<code>http://localhost:8080/docs/index.html</code> 查看swagger生成的Api文档信息</li>
    <li>根据需求进行快速迭代开发</li>
</ul>
